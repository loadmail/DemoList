...
public class ContactsListView extends ListView implements OnScrollListener {
	...
	public ContactsListView(final Context context, final AttributeSet attrs, final int defStyle) {
	...
	public void setAdapter(final ListAdapter adapter) {
		if (!(adapter instanceof ContactsListAdapter)) {
			throw new IllegalArgumentException("The adapter needds to be of type " + ContactsListAdapter.class + " and is " + adapter.getClass());
		}
	...
	public void onScroll(final AbsListView view, final int firstVisibleItem, final int visibleItemCount, final int totalItemCount) {
		...
		final boolean isFirstVisibleItemSection = ((ContactsListAdapter) adapter).isSection(firstVisibleItem);
