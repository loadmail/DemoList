...
public class WeatherActivity extends AppCompatActivity {
  ...
  public void onClick(View v){
    ...
    layout.startVerticalAnimate(1000);
    layout.startHorizontalAnimate(1000);
//tdAvatar.startHorizontalAnimate();
    tdAvatar.startVerticalAnimate(1000);

    for(int i = 0;i<list.size();i++){
      ((ThreeDLayout)recyclerView.getChildAt(i)).startHorizontalAnimateDelayed(100*i,1000);// TODO: 2016/10/17 这里100*i是线程睡眠时间,作为延迟动画
      ((ThreeDLayout)recyclerView.getChildAt(i)).startVerticalAnimate(1000);
    }
