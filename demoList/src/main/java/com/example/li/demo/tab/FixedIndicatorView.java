...
public class FixedIndicatorView extends LinearLayout implements Indicator {
    ...
    private class InRun implements Runnable {
        ...
        public InRun() {
            super();
            scroller = new Scroller(getContext(), sInterpolator); //scroller
        }
    ...
    /**
     * todo 参考 将view 添加到布局中心  addView(centerView, index, params);
     * todo 这里有没有用weight属性?
     * @param centerView
     * @param layoutParams
     */
