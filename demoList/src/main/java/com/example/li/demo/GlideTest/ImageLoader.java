...
/**
 * Glide库的封装使用
 * http://blog.csdn.net/mchenys/article/details/51635535
 */
public class ImageLoader {
    ...
    public static ImageLoadConfig defConfig = new ImageLoadConfig.Builder().
            ...
            setAsBitmap(true).
            setPlaceHolderResId(android.R.style.Widget_DeviceDefault_Light_ProgressBar).
    ...
    public static synchronized long getDiskCacheSize(Context context) {
        long size = 0L;
        File cacheDir = context.getDir("/cache", Context.MODE_WORLD_READABLE);
