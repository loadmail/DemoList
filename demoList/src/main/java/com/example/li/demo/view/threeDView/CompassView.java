...
/**
 * 参考学习地址:http://blog.csdn.net/wingichoy/article/details/50590051
 *
 * 实际值与分辨率很大关系
 * 具体的数值最好是dx to dp
...
public class CompassView extends View {
    ...
    public CompassView(Context context, AttributeSet attrs) {
        ...
        mCanvasMaxRotateDegree = 40;  // TODO: 2016/10/17 修改此值可以使效果炫酷 
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawText("N",mCenterX,mCenterY-dip2px(170),mPaint);
        canvas.drawText("S",mCenterX,mCenterY+dip2px(170),mPaint);
    ...
    private void drawPath(Canvas canvas) {
        ...
        mPath.moveTo(mCenterX,dip2px(235));
        mPath.lineTo(mCenterX-dip2px(15),mCenterY);
        mPath.lineTo(mCenterX,2*mCenterY-dip2px(235));
        mPath.lineTo(mCenterX+dip2px(15),mCenterY);
        mPath.lineTo(mCenterX,dip2px(235));
        mPath.close();
        canvas.drawPath(mPath,mPaint);

        //圆心
        mPaint.setColor(Color.parseColor("#553F7F"));// TODO: 2016/10/17 紫色圆心
        canvas.drawCircle(mCenterX,mCenterY,dip2px(10),mPaint);
    }
    ...
    private void drawArc(Canvas canvas) {
        ...
        for (int i = 0; i < 120; i++) { // TODO: 2016/10/17 120条白线
            ...
            canvas.drawLine(mCenterX, dip2px(250), mCenterX,dip2px(270), mPaint);
            canvas.drawCircle(mCenterX,dip2px(240),3,mPaint);
