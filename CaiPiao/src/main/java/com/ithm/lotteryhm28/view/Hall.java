...
//                switch (position) {
//                    case 1:
//                    // 当position从0移动到1 TranslateAnimation animation=new TranslateAnimation(0*GlobalParams.WIN_WIDTH/3, 1*GlobalParams.WIN_WIDTH/3, 0, 0);
//                        animation.setDuration(300);
//                        animation.setFillAfter(true);// 移动完后停留到终点
//
//                        underLine.startAnimation(animation);
...
//                    case 2:
//                    // 当position从1移动到2
//                     animation=new TranslateAnimation(1*GlobalParams.WIN_WIDTH/3, 2*GlobalParams.WIN_WIDTH/3, 0,
//                        0);
//                        animation.setDuration(300);
//                        animation.setFillAfter(true);// 移动完后停留到终点
//
